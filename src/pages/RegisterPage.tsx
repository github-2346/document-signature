      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-900 via-slate-900 to-blue-900/30 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative space-y-8">
          ...
          <p className="text-lg text-slate-400 max-w-md">
            Join thousands of businesses using DocuSign Pro for secure, 
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          <div className="lg:hidden flex items-center gap-3 mb-8 justify-center">
            ...
            <h1 className="text-xl font-bold text-white">DocuSign Pro</h1>
          </div>

          <div className="text-center mb-8">
            <h2 className="text-2xl font-bold text-white mb-2">Create your account</h2>
            <p className="text-slate-400">Get started with your free trial</p>
          </div>
